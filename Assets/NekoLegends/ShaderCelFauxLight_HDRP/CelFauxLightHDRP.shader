Shader "Neko Legends/Cel Faux Light HDRP"
{
    Properties
    {
        ...
        SubShader
        {
            Tags { "RenderType" = "Opaque" "RenderPipeline" = "HDRenderPipelineAsset" }
            LOD 100
            ...
            CustomEditorForRenderPipeline "NekoLegends.CelFauxLightHDRPInspector" "UnityEngine.Rendering.HighDefinition.HDRenderPipelineAsset"
}