...
{
    public class CelFauxLightHDRPInspector : ShaderGUIBase
    {
        ...
        protected virtual void ShowNormalSection(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            showNormalProperties = EditorPrefs.GetBool("CelFauxLightHDRPInspector_showNormalProperties", false);
            ...
            EditorPrefs.SetBool("CelFauxLightHDRPInspector_showNormalProperties", showNormalProperties);
        }
        ...
        protected virtual void ShowLightingSection(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            showLightingProperties = EditorPrefs.GetBool("CelFauxLightHDRPInspector_showLightingProperties", false);
            ...
            EditorGUILayout.EndFoldoutHeaderGroup();
            EditorPrefs.SetBool("CelFauxLightHDRPInspector_showLightingProperties", showLightingProperties);
        }
